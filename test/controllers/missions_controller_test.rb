...
class MissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post missions_url, params: { mission: { name: @mission.name, points: @mission.points } }
    end
  ...
  test "should update mission" do
    patch mission_url(@mission), params: { mission: { name: @mission.name, points: @mission.points } }
