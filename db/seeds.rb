...
wog = Category.create!(mission_type: 'Word of God')
ev = Category.create!(mission_type: 'Evangelism')
pray = Category.create!(mission_type: 'Prayer')
ser = Category.create!(mission_type: 'Service')
equ = Category.create!(mission_type: 'Equipping')

Mission.create!(name: 'Post a verse you wrote down from DT along with a 2-3 sentence sharing of how it spoke to you', points: 5, category: wog)
Mission.create!(name: 'Have a spiritual conversation with someone', points: 15, category: ev)
Mission.create!(name: 'Spend 10 minutes praying through the Kle3 Prayer Card', points: 5, category: pray)
Mission.create!(name: 'Do the dishes', points: 2, category: ser)
Mission.create!(name: 'Read Mere Christianity by C. S. Lewis', points: 15, category: equ)
